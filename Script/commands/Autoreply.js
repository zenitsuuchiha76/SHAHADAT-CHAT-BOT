...
module.exports.handleEvent = async function ({ api, event, Users }) {
  ...
  const responses = {
    "miss you": "অরেক বেডারে Miss না করে xan মেয়ে হলে বস গজু অরুপে পিউ পিউ রে হাঙ্গা করো😶👻😘",
    ...
    "owner": "‎[𝐎𝐖𝐍𝐄𝐑:☞ Gojo orupe piw piw☜\nFacebook: https://www.facebook.com/doremon.bhai.2024\nWhatsApp: +8801882333082",
    "admin": "He is 𝐆𝐨𝐣𝐨 তাকে সবাই Piw Piw হিসেবে চিনে😘☺️",
    ...
    "fork": "ফাইল চাইলে চুদে দিবো কোনো ফাইল নাই যা এখান থেকে",
    "kiss me": "তুমি পঁচা তোমাকে কিস দিবো না 🤭",
    "thanks": "এতো ধন্যবাদ না দিয়ে আমার বস গজু অরুপে পিউ পিউ রে তোর গার্লফ্রেন্ড টা দিয়ে দে..!🐸🥵",
    "i love you": "মেয়ে হলে আমার বস গজু অরুপে পিউ পিউ এর ইনবক্সে এখুনি গুঁতা দিন🫢😻",
    "by": "কিরে তুই কই যাস কোন মেয়ের সাথে চিপায় যাবি..!🌚🌶️",
    "ami gojo": "হ্যা বস কেমন আছেন..?☺️",
    "bot er baccha": "আমার বাচ্চা তো তোমার গার্লফ্রেন্ডের পেটে..!!🌚⛏️",
    "tor nam ki": "MY NAME IS ─꯭─⃝‌‌𝐏𝐢𝐰 𝐏𝐢𝐰 𝐂𝐡𝐚𝐭 𝐁𝐨𝐭💖",
    ...
    "love you": "ভালোবাসা নামক আবলামী করতে চাইলে Boss গোজু অরুপে পিউ পিউ এর ইনবক্সে গুতা দিন 😘",
